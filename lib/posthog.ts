...
// Surveys are disabled so no PostHog UI can ever appear on the page. Never give the <script> an id of "posthog":
// the element would become window.posthog and the stub would throw before register() and scroll tracking run.
