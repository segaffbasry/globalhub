...
/* The live "Grow your business" banner as a rounded green card (crazyui.com's pricing-card shape): the price is the headline. */
export default function Join() {
  return <section className="join" data-tone="light" data-soft aria-labelledby="join-title">
    <div className="wrap join-card" data-tone="green"><div className="join-grid">
